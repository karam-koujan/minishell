...
src/executor/builtins/pwd.o src/executor/builtins/cd.o src/executor/builtins/env.o  src/executor/builtins/export.o src/executor/builtins/export2.o src/executor/builtins/export3.o src/executor/builtins/export4.o src/executor/builtins/exit.o src/executor/builtins/unset.o src/executor/redirection/inf_outf_single_cmd.o src/executor/pipe/pipe.o src/executor/pipe/utils_pipe.o \
