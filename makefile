...
src/executor/builtins/pwd.o src/executor/builtins/cd.o src/executor/builtins/cd2.o src/executor/builtins/env.o  src/executor/builtins/export.o src/executor/builtins/export2.o src/executor/builtins/export3.o src/executor/builtins/export4.o src/executor/builtins/export5.o src/executor/builtins/exit.o src/executor/builtins/exit2.o src/executor/builtins/unset.o src/executor/redirection/inf_outf.o  src/executor/redirection/utils_inf_outf.o src/executor/pipe/pipe.o src/executor/pipe/utils_pipe.o \
