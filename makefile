...
src/error_checker/error_checker_helper.o  src/executor/helper_exec/utils_exec.o  src/executor/executor.o src/executor/here_doc.o  src/executor/here_doc2.o  src/executor/cmd/exec_cmd.o src/executor/cmd/check_cmd.o src/executor/cmd/utils_check_cmd.o  src/executor/load_env.o src/executor/shlvl.o src/executor/pwd_init.o  src/executor/builtins/echo.o ./src/executor/cmd/utils_check_cmd2.o \
src/executor/builtins/pwd.o src/executor/builtins/cd.o src/executor/builtins/cd2.o src/executor/builtins/env.o  src/executor/builtins/export.o src/executor/builtins/export2.o src/executor/builtins/export3.o src/executor/builtins/export4.o src/executor/builtins/export5.o src/executor/builtins/exit.o src/executor/builtins/exit2.o src/executor/builtins/unset.o src/executor/redirection/inf_outf.o  src/executor/redirection/utils_inf_outf.o src/executor/pipe/pipe.o src/executor/pipe/pipe2.o src/executor/pipe/utils_pipe.o \
